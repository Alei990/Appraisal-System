<%@ page language="java" import="java.util.*,test.DB,java.sql.ResultSet;" pageEncoding="UTF-8"%>
<%
...
<html>
  <head>
    ...
    <title>My JSP 'AchLog.jsp' starting page</title>
	...
	<script type="text/javascript" src="./JS/makenewtable.js"></script>
   ...
   <style>
    ...
    div#users-contain table td, div#users-contain table th { border: 2px solid #eee; padding: .6em 10px; text-align: center; }
  ...
  var flag3;
   	function option(i){
 		var s;
 		if(i==1){ s="<td style='color:red'>" + "<input type='button' value='修改' onclick='fe(this)'>" + "</td>" + "<td style='color:red'>" + "<input type='button' value='删除' onclick='deleteRow(this)'>" + "</td>"; return s;}
 		else if(i==2){ s="<td colspan='2' style='color:red;text-align:center;'>" + "<input type='button' value='申诉' onclick=''>" + "</td>"; return s ;}
 		else { s="<td colspan='2' style='color:red'>" + " " + "</td>"; return s;}
 	}
  $(function() {
    var name = $( "#name" ),
      situation = $( "#situation" ),
